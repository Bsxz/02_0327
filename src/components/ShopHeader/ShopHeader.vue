    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <span class="content-name" @click="toggleshopShow">{{ info.name }}</span>
    ...
    <transition name="sheet">
      <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item activity-red" v-for="(support,index) in info.supports"
                :key="index"
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-guanbi" @click="togglesupportShow"></span>
          </div>
        </div>
