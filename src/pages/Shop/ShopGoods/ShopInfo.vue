  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div v-for="(support,index) in info.supports"
               v-if="info.supports"
               :key="index"
...
<span class="mini-tag">{{ support.name }}</span>
      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul ref="picsUl" class="pic-list">
            <li v-for="(pics,index) in info.pics" :key="index" class="pic-item">
              <img v-lazy="pics" height="90"
                   width="120"/>
            </li>
          </ul>
        </div>
      ...
      <section class="section">
        ...
        <ul class="detail">
          ...
          <li><span class="bold">地址</span><span class="bold_add">{{ info.address }}</span></li>
